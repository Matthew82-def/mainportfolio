  ...
  return (
    <div id='contact' className='w-full lg:h-screen'>
      <div className='max-w-[1240px] m-auto px-2 py-16 w-full '>
        <p className='text-xl tracking-widest uppercase text-[#5335a5]'>Contact</p>
              ...
              {formSuccess ? (
                ...
                <form
                  ...
                  <div className='grid md:grid-cols-2 gap-4 w-full py-2'>
                    ...
                    <div className='flex flex-col'>
                      <label className='uppercase text-sm py-2' for='phoneNumber'>
                        Phone Number
                      </label>
                      <input
                        className='border-2 rounded-lg p-3 flex border-blue-300'
                  ...
                  <button className='w-full p-4 text-blue-100 mt-4'>Send Message</button>
                </form>
              )}
            </div>
          </div>
